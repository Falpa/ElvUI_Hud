...
L["Set the Alpha of the Hud when out of combat"] = "Установите прозрачность элементов вне боя"
...
L["Target Hud"] = "Цель"
L["Pet Hud"] = "Питомец"
L["Target Target Hud"] = "Цель цели"
L["Pet Target Hud"] = "Цель питомца"
L["Point From"] = "Начальная точка"
L["Position on the element to anchor"] = "Какой точкой элемент будет крепиться к фиксатору"
L['What to attach this element to.'] = "К чему прикреплять этот элемент"
L['Point To'] = "Точка фиксации"
L["Eclipse"] = "Затмение"
L["Override"] = "Заменить"
L["Override the texture for this element"] = "Заменить стандартную текстуру для этого элемента"
L['ElvUI Hud by Sortokk'] = "ElvUI Hud от Sortokk"
L['ElvUI Hud provides a configurable Heads Up Display for use with ElvUI.\n'] = "ElvUI Hud добавляет настраеваемый Heads Up Display для ElvUI."
L['Reset the settings of this addon to their defaults.'] = "Сбросить настройки аддона на умолчания"
L['Hide the ElvUI Unitframes when the Hud is enabled'] = "Скрывать рамки юнитов ElvUI, когда включен Hud"
L['Hide the Hud when out of Combat'] = "Скрывать Hud внее боя"
L['Hide Out of Combat'] = "Скрывать вне боя"
L['Enable Mouse'] = "Разрешить мышь"
L['Enable the mouse to interface with the hud (this option has no effect if ElvUI Unitframes are hidden)'] = "Сделать Hud воспринимать клики мышью (опция не оказывает эффекта при скрытых рамках ElvUI)"
L['Set the Alpha of the Hud when in combat'] = "Установите прозрачность элементов в бою"
L['Position on the attached element to anchor to'] = "Точка на фиксаторе, к которой будет крепиться элемент"
