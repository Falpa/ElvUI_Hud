...
if db.simpleLayout then
	...
	H:RegisterHudFrames(player_health)
	...
	if db.simpleTarget then
		...
		H:RegisterHudFrames(target_health)
	end
	...
	H:RegisterHudFrames(player_power)
	...
	if db.simpleTarget then
		...
		H:RegisterHudFrames(target_power)
	end
else
	...
	H:RegisterHudFrames(player_hud)
	...
	H:RegisterHudFrames(target_hud)
