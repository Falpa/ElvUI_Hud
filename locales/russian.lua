...
L['Enable the mouse to interface with the hud (this option has no effect is ElvUI Unitframes are hidden)'] = "Сделать Hud воспринимать клики мышью (опция не оказывает эффекта при скрытых рамках ElvUI)"
